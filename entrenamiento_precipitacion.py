...
# 1. Leer el CSV
ruta = "precipitacion_mensual.csv"
df = pd.read_csv(ruta)
...
temperaturas = df['Precipitacion'].astype(float)
...
plt.title("Predicción de precipitacion Mensual (SARIMA)")
plt.xlabel("Fecha")
plt.ylabel("°C")
plt.legend()
plt.grid()
...
joblib.dump(resultado, "modelo_sarima_pre.pkl")
print("✅ Modelo guardado como 'modelo_sarima_pre.pkl'")
